let phrases = [
  ...
  { text: 'баран утуйарыскай', image: 'https://code.s3.yandex.net/web-code/procrastinate/3.png' },
  { text: 'потискать Юнтю', image: 'https://code.s3.yandex.net/web-code/procrastinate/4.png' },
